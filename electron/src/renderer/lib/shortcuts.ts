...
export const DEFAULT_SHORTCUT_BINDINGS: ShortcutBindings = {
  copy: 'primary+c', cut: 'primary+x', paste: 'primary+v', duplicate: 'primary+d', cleanLayout: 'primary+l', export: 'primary+e', undo: 'primary+z', redo: 'primary+shift+z',
...
export const SHORTCUTS: ShortcutGroup[] = [
  { category: 'Tools', shortcuts: [{ keys: 'Esc', description: 'Select tool' }, { keys: 'C', description: 'Carbon atom (C)' }, { keys: 'N', description: 'Nitrogen atom (N)' }, { keys: 'O', description: 'Oxygen atom (O)' }, { keys: 'S', description: 'Sulfur atom (S)' }, { keys: 'P', description: 'Phosphorus atom (P)' }, { keys: '1 / 2 / 3 / 4', description: 'Bond order tools' }, { keys: '6', description: 'Insert six-membered carbon ring' }, { keys: 'Del', description: 'Eraser / Delete' }] },
  { category: 'Keyboard Canvas Editing', shortcuts: [{ keys: 'Tab', description: 'Focus the canvas (auto-selects the first atom)' }, { keys: 'Arrow keys', description: 'Move the roving atom focus' }, { keys: 'Alt+Arrow keys', description: 'Nudge selected atoms by one unit' }, { keys: 'Alt+Shift+Arrow', description: 'Nudge selected atoms by ten units' }, { keys: 'Shift+C/N/O/S/P', description: 'Add that element, bonded to the focused atom' }, { keys: 'Shift+drag', description: 'Select atoms and internal bonds in a rectangle' }, { keys: 'Enter', description: 'Start bonding the focused atom' }] },
  ...
  { category: 'Editing', shortcuts: [{ action: 'undo', keys: DEFAULT_SHORTCUT_BINDINGS.undo, description: 'Undo', configurable: true }, { action: 'redo', keys: DEFAULT_SHORTCUT_BINDINGS.redo, description: 'Redo', configurable: true }, { action: 'copy', keys: DEFAULT_SHORTCUT_BINDINGS.copy, description: 'Copy selected structure', configurable: true }, { action: 'cut', keys: DEFAULT_SHORTCUT_BINDINGS.cut, description: 'Cut selected structure', configurable: true }, { action: 'paste', keys: DEFAULT_SHORTCUT_BINDINGS.paste, description: 'Paste structure', configurable: true }, { action: 'duplicate', keys: DEFAULT_SHORTCUT_BINDINGS.duplicate, description: 'Duplicate selected structure', configurable: true }, { action: 'cleanLayout', keys: DEFAULT_SHORTCUT_BINDINGS.cleanLayout, description: 'Clean layout', configurable: true }, { action: 'selectAll', keys: DEFAULT_SHORTCUT_BINDINGS.selectAll, description: 'Select all', configurable: true }, { action: 'delete', keys: DEFAULT_SHORTCUT_BINDINGS.delete, description: 'Delete selected atoms/bonds', configurable: true }] },
  ...
  { category: 'Navigation', shortcuts: [{ keys: 'Cmd+K / Ctrl+K', description: 'Focus feature search' }] },
  { category: 'ChemDraw map', shortcuts: [
    { keys: 'Left palette', description: 'Main drawing tools and ring insertion' },
    { keys: 'Object menu', description: 'Alignment and rotation' },
    { keys: 'Structure menu', description: 'Clean up and structure analysis' },
    { keys: 'Search menu', description: 'Database, identifiers, and MCS' },
    { keys: 'Window menu', description: 'Inspector, templates, reactions, 3D, and NMR panels' },
    { keys: 'Right panel', description: 'Selection-sensitive atom and bond properties' },
  ] },
