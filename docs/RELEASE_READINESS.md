...
| P0 | CDXML writer, matrix, round-trip corpus | Partial | Supported atom/bond subset and parser-backed corpus pass; advanced pages/labels/stereo/text remain open. |
...
| P1 | Electron-free packages and consumer conformance | Open | No extracted core/formats/UI package boundary exists yet; current supported surface is Electron renderer + WASM. |
