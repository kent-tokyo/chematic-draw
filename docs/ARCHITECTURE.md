...
4. **Computation (WASM/Rust)**
   - SMILES/MOL/SDF/CML/CDXML parsing and supported-subset writing
...
| **Chemistry Engine** | chematic (Rust) | Molecule operations | 1.0.4 (`v1.0.4`) |
...
`renderer/lib/documentCommands.ts` is the v0.9.3 integration boundary. Local
