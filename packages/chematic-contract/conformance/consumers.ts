...
export const contractSurfaceFixture: {
  ...
  session: { schema: 'chematic-draw/session-bundle', schema_version: 2, app: { name: 'chematic-draw', engine: 'chematic 1.0.3' }, source: { file_path: null }, document: { schema_version: 1, molecule }, provenance: { operation: 'export-session-bundle', structure_hash: 'fnv1a-32:00000000' } },
  batch: { operation: 'validate', processed: 0, failed: 0, skipped: 0, resultHash: 'fnv1a-32:00000000', errors: [], timestamp: 0, provenance: { engine: 'chematic 1.0.3' }, items: [] },
